  ...
  <footer class="bg-gray-950 py-12 border-t border-gray-800">
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <div class="mb-6 md:mb-0">
          <div class="flex items-center">
            <span class="text-primary-500 font-bold text-2xl">Bookmark</span>
            <span class="text-secondary-400 font-bold text-2xl">Manager</span>
          </div>
          <p class="text-gray-400 mt-2">Organize your online world</p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8 mb-6 md:mb-0">
          ...
          <!-- <div>
            <h3 class="text-white font-semibold mb-3">Project</h3>
            <ul class="space-y-2">
              <li><a href="https://github.com/poesterlin/bookmarkManager" class="text-gray-400 hover:text-primary-400 transition-colors">GitHub</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary-400 transition-colors">Roadmap</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary-400 transition-colors">Contribute</a></li>
            </ul>
          </div> -->
      ...
      <div class="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
        <!-- <p class="text-gray-500 text-sm">© {currentYear} BookmarkManager. All rights reserved.</p> -->
        
        <div class="flex space-x-4 mt-4 md:mt-0">
          <a href="https://github.com/poesterlin/bookmarkManager" aria-label="to Github" class="text-gray-400 hover:text-primary-400 transition-colors">
