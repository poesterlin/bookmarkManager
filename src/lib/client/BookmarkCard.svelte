...
<div
	class="glass group overflow-hidden rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
>
	<div class="relative p-4">
		...
		<div class="pt-5 flex flex-wrap gap-1">
		...
		<div class="flex items-center justify-between border-t border-white/30 pt-5">
			<a
				href={bookmark.url}
				target="_blank"
